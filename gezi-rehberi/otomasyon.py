...
# DİKKAT: ttl=5 yaptık ki Strapi çökerse/kapanırsa boş listeyi uzun süre hafızada tutup seni yanıltmasın!
@st.cache_data(ttl=5)
def sehirleri_getir():
    ...
    try:
        ...
        if cevap.status_code == 200:
            ...
            for s in sehirler:
                ...
                # Eğer 'ad' verisi bize {'ad': 'Edirne'} gibi bir paket olarak geliyorsa içini aç
...
def verileri_getir(secilen_sehir, dil_kodu):
    ...
    try:
        ...
        # Filtreleme tam olarak senin Strapi veritabanı yapına göre ayarlandı!
