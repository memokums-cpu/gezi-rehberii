...
if dil_kodu == "tr":
    mekanlar_listesi = [
        ...
        {"id": 11, "attributes": {"ad": "Sagrada Familia", "Aciklama": "Barselona'da bulunan, Gaudi'nin tamamlanmamış mimari harikası bazilika.", "Puan": 5, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1574676570114-1628d0955685?q=80&w=400"}}}}},
        ...
        {"id": 13, "attributes": {"ad": "Özgürlük Heykeli", "Aciklama": "New York'ta bulunan, demokrasi ve özgürlüğün evrensel sembolü.", "Puan": 4, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1605833556294-3196a68235bc?q=80&w=400"}}}}},
        {"id": 14, "attributes": {"ad": "Fuji Dağı", "Aciklama": "Japonya'nın simgesi olan, karla kaplı zirvesiyle kutsal aktif yanardağ.", "Puan": 5, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1545579133-9985ab1fabfda?q=80&w=400"}}}}},
    ...
    mekanlar_listesi = [
        ...
        {"id": 11, "attributes": {"ad": "Sagrada Familia", "Aciklama": "Gaudi's masterpiece, an architectural wonder basilica in Barcelona.", "Puan": 5, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1574676570114-1628d0955685?q=80&w=400"}}}}},
        ...
        {"id": 13, "attributes": {"ad": "Statue of Liberty", "Aciklama": "Universal symbol of freedom and democracy located in New York.", "Puan": 4, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1605833556294-3196a68235bc?q=80&w=400"}}}}},
        {"id": 14, "attributes": {"ad": "Mount Fuji", "Aciklama": "Iconic, sacred, and active volcano in Japan, famous for its snowy peak.", "Puan": 5, "KapakResmi": {"data": {"attributes": {"url": "https://images.unsplash.com/photo-1545579133-9985ab1fabfda?q=80&w=400"}}}}},
